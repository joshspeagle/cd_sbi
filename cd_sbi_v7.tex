...
A \emph{normalizing flow} \citep[for an overview,
see][]{PapamakariosEtAl2021} is a parametric family of diffeomorphisms
...
from the scoring-rule literature; \citealp{GneitingRaftery2007} is the
...
function as the integral of a positive function from a free neural net,
or via
...
proper direction. Concretely, using the dual ("kernel-score") form of
