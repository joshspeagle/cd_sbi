...
miscalibration that Hermans et al.~(2022) documented in standard SBI
...
Conservative regularizer & Delaunoy et al.~2022 \\
...
(Cranmer et al.~2015). For the location-normal model the score
...
ratio (Schweder \& Hjort 2016, ch.~5).
...
(Carlier--Galichon--Santambrogio 2010) connects KR maps to Brenier maps
through an entropic/diagonal-scaling continuation, raising the
...
is open. Wehenkel et al.~(2025) study a related question via a
...
Robust-SBI ideas (Schmon et al.~2020; Dellaporta et al.~2022) should
also integrate with CD-SBI but the right framework is unclear.
...
dimension. Autoregressive flows scale routinely to \(d \sim 30\) in the
SBI literature (Lueckmann et al.~2021) and to \(d \sim 100\)+ in
general normalizing-flow contexts (Papamakarios et al.~2017;
Durkan et al.~2019). What is specific to CD-SBI is the requirement
...
\item \emph{Naive sequential CD-SBI (adapting \(\rho\) to concentrate
  ...
  argument of \S\ref{subsec:1.3}, and the broader sequential-SBI literature
  (Hermans et al.~2022; Lueckmann et al.~2021) has documented empirical
...
\item \emph{Whether an importance-reweighted or APT-style corrected
  ...
  open.} The closest existing work is Falkiewicz et al.~(2023)
